define([], function() {
	...
	var stationsMap = {
		Bakerloo : [
			...
			{ code : 'OXC' , name : 'Oxford Circus', atLength : [524] ,position : { x : 1139, y : 812, type: 'circle', text : 'W'}},
		...
		Victoria : [
			...
			{ code : 'OXC' , name : 'Oxford Circus', atLength : [694] ,position : { x : 1139, y : 812, type: 'circle', text : 'W'}},
...
/**/		{ code : 'NHG' , name : 'Notting Hill Gate', atLength : [2454] ,position : { x : 858, y : 812, type: 'circle', text : 'N'}},
...
/**/		{ code : 'WDL' , name : 'Wood Lane', atLength : [133] ,position : { x : 696, y : 847, type: 'circle', text : '-'}}  			
		...
		Jubilee : [
			...
			{ code : 'BDS' , name : 'Bond Street', atLength : [1632] ,position : { x : 1060, y : 812, type: 'circle', text : 'N'}},
...
/**/		{ code : 'NHG' , name : 'Notting Hill Gate', atLength : [584,584,584,584] ,position : { x : 858, y : 812, type: 'circle', text : '-'}},
/**/		{ code : 'PAD' , name : 'Paddington', atLength : [708,708,708,708] ,position : { x : 867, y : 696, type: 'circle', text : '-'}}, 
			...
			{ code : 'UPB' , name : 'Upminster Bridge', atLength : [42,42,42,42] ,position : { x : 2409, y : 431, type: 'rect', text : 'E'}},
		...
		Central : [  
			{ code : 'BNK' , name : 'Bank', atLength : [1708,1166] ,position : { x : 1498, y : 861, type: 'circle', text : 'N'}},
			{ code : 'BDE' , name : 'Barkingside', atLength : [0,2242] ,position : { x : 2227, y : 328, type: 'rect', text : 'W'}}, 
			{ code : 'BNG' , name : 'Bethnal Green', atLength : [2088,1546] ,position : { x : 1818, y : 718, type: 'rect', text : 'N'}}, 
			{ code : 'BDS' , name : 'Bond Street', atLength : [1251,709] ,position : { x : 1060, y : 812, type: 'circle', text : '-'}}, 
			{ code : 'BHL' , name : 'Buckhurst Hill', atLength : [2814,0] ,position : { x : 2074, y : 154, type: 'rect', text : 'W'}}, 
			{ code : 'CYL' , name : 'Chancery Lane', atLength : [1588,1046] ,position : { x : 1394, y : 812, type: 'rect', text : 'N'}}, 
			{ code : 'CHG' , name : 'Chigwell', atLength : [0,2420] ,position : { x : 2148, y : 225, type: 'rect', text : 'S'}}, 
			{ code : 'DEB' , name : 'Debden', atLength : [2874,0] ,position : { x : 2074, y : 90, type: 'rect', text : 'W'}}, 
			{ code : 'EBY' , name : 'Ealing Broadway', atLength : [0,6] ,position : { x : 354, y : 819, type: 'circle', text : '-'}}, 
			{ code : 'EAC' , name : 'East Acton', atLength : [808,266] ,position : { x : 613, y : 812, type: 'rect', text : 'N'}}, 
			{ code : 'EPP' , name : 'Epping', atLength : [2928,0] ,position : { x : 2074, y : 35, type: 'circle', text : 'N'}}, 
			{ code : 'FLP' , name : 'Fairlop', atLength : [0,2270] ,position : { x : 2227, y : 297, type: 'rect', text : 'W'}}, 
			{ code : 'GHL' , name : 'Gants Hill', atLength : [0,2142] ,position : { x : 2190, y : 402, type: 'rect', text : 'S'}}, 
			{ code : 'GRH' , name : 'Grange Hill', atLength : [0,2378] ,position : { x : 2186, y : 219, type: 'rect', text : 'N'}}, 
			{ code : 'GFD' , name : 'Greenford', atLength : [366,0] ,position : { x : 276, y : 564, type: 'circle', text : 'W'}}, 
			{ code : 'HAI' , name : 'Hainault', atLength : [0,2308] ,position : { x : 2227, y : 261, type: 'circle', text : 'W'}}, 
			{ code : 'HLN' , name : 'Hanger Lane', atLength : [524,0] ,position : { x : 384, y : 673, type: 'rect', text : 'W'}}, 
			{ code : 'HOL' , name : 'Holborn', atLength : [1508,966] ,position : { x : 1318, y : 816, type: 'circle', text : 'S'}}, 
			{ code : 'HPK' , name : 'Holland Park', atLength : [1000,458] ,position : { x : 807, y : 818, type: 'rect', text : 'S'}}, 
			{ code : 'LAN' , name : 'Lancaster Gate', atLength : [1162,620] ,position : { x : 969, y : 812, type: 'rect', text : 'N'}}, 
			{ code : 'LEY' , name : 'Leyton', atLength : [2416,1874] ,position : { x : 2074, y : 548, type: 'rect', text : 'W'}}, 
			{ code : 'LYS' , name : 'Leytonstone', atLength : [2498,1956] ,position : { x : 2074, y : 465, type: 'rect', text : 'W'}}, 
			{ code : 'LST' , name : 'Liverpool Street', atLength : [1866,1324] ,position : { x : 1625, y : 788, type: 'circle', text : 'S'}}, 
			{ code : 'LTN' , name : 'Loughton', atLength : [2846,0] ,position : { x : 2074, y : 118, type: 'rect', text : 'W'}}, 
			{ code : 'MAR' , name : 'Marble Arch', atLength : [1205,663] ,position : { x : 1010, y : 818, type: 'rect', text : 'S'}}, 
			{ code : 'MLE' , name : 'Mile End', atLength : [2152,1610] ,position : { x : 1884, y : 722, type: 'circle', text : 'N'}}, 
			{ code : 'NEP' , name : 'Newbury Park', atLength : [0,2204] ,position : { x : 2227, y : 362, type: 'rect', text : 'W'}}, 
			{ code : 'NAC' , name : 'North Acton', atLength : [778,236] ,position : { x : 582, y : 818, type: 'rect', text : 'S'}}, 
			{ code : 'NHT' , name : 'Northolt', atLength : [264,0] ,position : { x : 260, y : 467, type: 'rect', text : 'W'}}, 
			{ code : 'NHG' , name : 'Notting Hill Gate', atLength : [1050,508] ,position : { x : 858, y : 812, type: 'circle', text : '-'}}, 
			{ code : 'OXC' , name : 'Oxford Circus', atLength : [1328,790] ,position : { x : 1139, y : 812, type: 'circle', text : '-'}}, 
			{ code : 'PER' , name : 'Perivale', atLength : [440,0] ,position : { x : 327, y : 616, type: 'rect', text : 'W'}}, 
			{ code : 'QWY' , name : 'Queensway', atLength : [1118,576] ,position : { x : 922, y : 818, type: 'rect', text : 'S'}}, 
			{ code : 'RED' , name : 'Redbridge', atLength : [0,2100] ,position : { x : 2149, y : 397, type: 'rect', text : 'N'}}, 
			{ code : 'ROD' , name : 'Roding Valley', atLength : [0,2462] ,position : { x : 2108, y : 223, type: 'circle', text : 'N'}}, 
			{ code : 'RUG' , name : 'Ruislip Gardens', atLength : [130,0] ,position : { x : 260, y : 333, type: 'rect', text : 'W'}}, 
			{ code : 'SBC' , name : 'Shepherds Bush', atLength : [948,406] ,position : { x : 757, y : 816, type: 'circle', text : 'N'}}, 
			{ code : 'SNB' , name : 'Snaresbrook', atLength : [2622,0] ,position : { x : 2074, y : 343, type: 'rect', text : 'W'}}, 
			{ code : 'SRP' , name : 'South Ruislip', atLength : [190,0] ,position : { x : 260, y : 397, type: 'circle', text : 'W'}}, 
			{ code : 'SWF' , name : 'South Woodford', atLength : [2658,0] ,position : { x : 2074, y : 309, type: 'rect', text : 'W'}}, 
			{ code : 'STP' , name : 'St Pauls', atLength : [1634,1092] ,position : { x : 1429, y : 833, type: 'rect', text : 'E'}}, 
			{ code : 'SFD' , name : 'Stratford', atLength : [2336,1794] ,position : { x : 2022, y : 610, type: 'circle', text : '-'}}, 
			{ code : 'THB' , name : 'Theydon Bois', atLength : [2905,0] ,position : { x : 2074, y : 61, type: 'rect', text : 'W'}}, 
			{ code : 'TCR' , name : 'Tottenham Court Road', atLength : [1450,908] ,position : { x : 1257, y : 816, type: 'circle', text : 'S'}}, 
			{ code : 'WAN' , name : 'Wanstead', atLength : [0,2062] ,position : { x : 2110, y : 402, type: 'rect', text : 'S'}}, 
			{ code : 'WAC' , name : 'West Acton', atLength : [0,134] ,position : { x : 480, y : 818, type: 'rect', text : 'S'}}, 
			{ code : 'WRP' , name : 'West Ruislip', atLength : [0,0] ,position : { x : 260, y : 200, type: 'circle', text : 'W'}}, 
			{ code : 'WCT' , name : 'White City', atLength : [858,316] ,position : { x : 666, y : 816, type: 'circle', text : 'N'}}, 
			{ code : 'WFD' , name : 'Woodford', atLength : [2692,0] ,position : { x : 2074, y : 274, type: 'circle', text : 'W'}}  
		]
	} 
