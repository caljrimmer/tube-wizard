...
/**/		{ code : 'WDL' , name : 'Wood Lane', atLength : 133 ,position : { x : 696, y : 847, type: 'circle', text : '-'}}  			
		...
		Jubilee : [
			{ code : 'BST' , name : 'Baker Street', atLength : 1 ,position : { x : 1060, y : 698, type: 'circle', text : '-'}},
			{ code : 'BER' , name : 'Bermondsey', atLength : 1 ,position : { x : 1653, y : 1028, type: 'circle', text : 'N'}},
			{ code : 'BDS' , name : 'Bond Street', atLength : 1 ,position : { x : 1060, y : 817, type: 'circle', text : 'N'}},
			{ code : 'CWR' , name : 'Canada Water', atLength : 1 ,position : { x : 1773, y : 1028, type: 'circle', text : 'N'}},
			{ code : 'CWF' , name : 'Canary Wharf', atLength : 1 ,position : { x : 1928, y : 1028, type: 'circle', text : 'N'}},
			{ code : 'CNT' , name : 'Canning Town', atLength : 1 ,position : { x : 2068, y : 911, type: 'circle', text : 'N'}},
			{ code : 'CPK' , name : 'Canons Park', atLength : 1 ,position : { x : 794, y : 252, type : 'rect', text : 'E', attr : { rotate : 0, offset : { x : 0, y : 0}}}},
			{ code : 'DHL' , name : 'Dollis Hill', atLength : 1 ,position : { x : 860, y : 419, type : 'rect', text : 'E', attr : { rotate : 0, offset : { x : 0, y : 0}}}},
			{ code : 'FRD' , name : 'Finchley Road', atLength : 1 ,position : { x : 977, y : 537, type: 'circle', text : 'E'}},
			{ code : 'GPK' , name : 'Green Park', atLength : 1 ,position : { x : 1079, y : 897, type: 'circle', text : '-'}},
			{ code : 'KIL' , name : 'Kilburn', atLength : 1 ,position : { x : 921, y : 481, type: 'circle', text : 'E'}},
			{ code : 'KBY' , name : 'Kingsbury', atLength : 1 ,position : { x : 794, y : 319, type : 'rect', text : 'E', attr : { rotate : 0, offset : { x : 0, y : 0}}}},
			{ code : 'LON' , name : 'London Bridge', atLength : 1 ,position : { x : 1519, y : 1028, type: 'circle', text : 'N'}},
			{ code : 'NEA' , name : 'Neasden', atLength : 1 ,position : { x : 832, y : 391, type : 'rect', text : 'E', attr : { rotate : 0, offset : { x : 0, y : 0}}}},
			{ code : 'NGW' , name : 'North Greenwich', atLength : 1 ,position : { x : 2009, y : 1017, type: 'circle', text : 'E'}},
			{ code : 'QBY' , name : 'Queensbury', atLength : 1 ,position : { x : 794, y : 287, type : 'rect', text : 'E', attr : { rotate : 0, offset : { x : 0, y : 0}}}},
			{ code : 'SWK' , name : 'Southwark', atLength : 1 ,position : { x : 1337, y : 1119, type: 'circle', text : 'S'}},
			{ code : 'SJW' , name : 'St Johns Wood', atLength : 1 ,position : { x : 1024, y : 582, type : 'rect', text : 'E', attr : { rotate : 0, offset : { x : 0, y : 0}}}}, 
			{ code : 'STA' , name : 'Stanmore', atLength : 1 ,position : { x : 794, y : 219, type: 'circle', text : '-'}},
			{ code : 'SFD' , name : 'Stratford', atLength : 1 ,position : { x : 2022, y : 610, type: 'circle', text : 'N'}},
			{ code : 'SWC' , name : 'Swiss Cottage', atLength : 1 ,position : { x : 999, y : 561, type : 'rect', text : 'E', attr : { rotate : 0, offset : { x : 0, y : 0}}}},
			{ code : 'WLO' , name : 'Waterloo', atLength : 1 ,position : { x : 1234, y : 1084, type: 'circle', text : 'N'}},
			{ code : 'WPK' , name : 'Wembley Park', atLength : 1 ,position : { x : 809, y : 369, type: 'circle', text : '-'}},
			{ code : 'WHM' , name : 'West Ham', atLength : 1 ,position : { x : 2067, y : 744, type: 'circle', text : '-'}},
			{ code : 'WHD' , name : 'West Hampstead', atLength : 1 ,position : { x : 947, y : 507, type: 'circle', text : 'E'}},
			{ code : 'WMS' , name : 'Westminster', atLength : 1 ,position : { x : 1200, y : 1014, type: 'circle', text : '-'}},
