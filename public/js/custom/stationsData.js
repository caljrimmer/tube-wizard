...
/**/		{ code : 'WDL' , name : 'Wood Lane', atLength : 133 ,position : { x : 696, y : 847, type: 'circle', text : '-'}}  			
		...
		Jubilee : [
			...
			{ code : 'CPK' , name : 'Canons Park', atLength : 2304 ,position : { x : 794, y : 252, type : 'rect', text : 'E', attr : { rotate : 0, offset : { x : 0, y : 0}}}},
			{ code : 'DHL' , name : 'Dollis Hill', atLength : 2106 ,position : { x : 860, y : 419, type : 'rect', text : 'E', attr : { rotate : 0, offset : { x : 0, y : 0}}}},
			...
			{ code : 'KBY' , name : 'Kingsbury', atLength : 2234 ,position : { x : 794, y : 319, type : 'rect', text : 'E', attr : { rotate : 0, offset : { x : 0, y : 0}}}},
			{ code : 'LON' , name : 'London Bridge', atLength : 946 ,position : { x : 1519, y : 1028, type: 'circle', text : 'N'}},
			{ code : 'NEA' , name : 'Neasden', atLength : 2143 ,position : { x : 832, y : 391, type : 'rect', text : 'E', attr : { rotate : 0, offset : { x : 0, y : 0}}}},
			{ code : 'NGW' , name : 'North Greenwich', atLength : 454 ,position : { x : 2009, y : 1017, type: 'circle', text : 'E'}},
			{ code : 'QBY' , name : 'Queensbury', atLength : 2268 ,position : { x : 794, y : 287, type : 'rect', text : 'E', attr : { rotate : 0, offset : { x : 0, y : 0}}}},
			{ code : 'SWK' , name : 'Southwark', atLength : 1164 ,position : { x : 1337, y : 1119, type: 'circle', text : 'S'}},
			{ code : 'SJW' , name : 'St Johns Wood', atLength : 1874 ,position : { x : 1024, y : 582, type : 'rect', text : 'E', attr : { rotate : 0, offset : { x : 0, y : 0}}}}, 
			...
			{ code : 'SWC' , name : 'Swiss Cottage', atLength : 1906 ,position : { x : 999, y : 561, type : 'rect', text : 'E', attr : { rotate : 0, offset : { x : 0, y : 0}}}},
			{ code : 'WLO' , name : 'Waterloo', atLength : 1292 ,position : { x : 1234, y : 1084, type: 'circle', text : 'N'}},
			...
			{ code : 'WLG' , name : 'Willesden Green', atLength : 1 ,position : { x : 889, y : 448, type : 'rect', text : 'E', attr : { rotate : 0, offset : { x : 0, y : 0}}}}
		],
		District : [
			{ code : 'ACT' , name : 'Acton Town', atLength : 0 ,position : { x : 416, y : 1001, type: 'circle', text : 'N'}}, 
			{ code : 'ALE' , name : 'Aldgate East', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'BKG' , name : 'Barking', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'BCT' , name : 'Barons Court', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'BEC' , name : 'Becontree', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'BLF' , name : 'Blackfriars', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'BWR' , name : 'Bow Road', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'BBB' , name : 'Bromley-by-Bow', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'CST' , name : 'Cannon Street', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'CHP' , name : 'Chiswick Park', atLength : 0 ,position : { x : 447, y : 1021, type : 'rect', text : 'S', attr : { rotate : 90, offset : { x : 0, y : 0}}}},
			{ code : 'DGE' , name : 'Dagenham East', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'DGH' , name : 'Dagenham Heathway', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'EBY' , name : 'Ealing Broadway', atLength : 0 ,position : { x : 354, y : 820, type: 'circle', text : 'N'}},
			{ code : 'ECM' , name : 'Ealing Common', atLength : 0 ,position : { x : 398, y : 912, type: 'circle', text : 'W'}},
			{ code : 'ECT' , name : 'Earls Court', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'EHM' , name : 'East Ham', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'EPY' , name : 'East Putney', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'ERD' , name : 'Edgware Road (H & C)', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'EPK' , name : 'Elm Park', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'EMB' , name : 'Embankment', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'FBY' , name : 'Fulham Broadway', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'GRD' , name : 'Gloucester Road', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'GUN' , name : 'Gunnersbury', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'HMD' , name : 'Hammersmith (District and Picc)', atLength : 0 ,position : { x : 697, y : 1020, type: 'circle', text : 'S'}},
			{ code : 'HST' , name : 'High Street Kensington', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'HCH' , name : 'Hornchurch', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'OLY' , name : 'Kensington (Olympia)', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'KEW' , name : 'Kew Gardens', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'MAN' , name : 'Mansion House', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'MLE' , name : 'Mile End', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'MON' , name : 'Monument', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'OLY' , name : 'Olympia', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'PGR' , name : 'Parsons Green', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'PLW' , name : 'Plaistow', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'PUT' , name : 'Putney Bridge', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'RCP' , name : 'Ravenscourt Park', atLength : 0 ,position : { x : 654, y : 1021, type : 'rect', text : 'S', attr : { rotate : 90, offset : { x : 0, y : 0}}}},
			{ code : 'RMD' , name : 'Richmond', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'SSQ' , name : 'Sloane Square', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'SKN' , name : 'South Kensington', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'SFS' , name : 'Southfields', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'SJP' , name : 'St. James Park', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'STB' , name : 'Stamford Brook', atLength : 0 ,position : { x : 584, y : 1021, type : 'rect', text : 'S', attr : { rotate : 90, offset : { x : 0, y : 0}}}},
			{ code : 'STG' , name : 'Stepney Green', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'TEM' , name : 'Temple', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'THL' , name : 'Tower Hill', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'TGR' , name : 'Turnham Green', atLength : 0 ,position : { x : 522, y : 1021, type: 'circle', type : 'rect', text : 'S', attr : { rotate : 90, offset : { x : 0, y : 0}}}},
			{ code : 'UPM' , name : 'Upminster', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'UPB' , name : 'Upminster Bridge', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'UPY' , name : 'Upney', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'UPK' , name : 'Upton Park', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'VIC' , name : 'Victoria', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'WBT' , name : 'West Brompton', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'WHM' , name : 'West Ham', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'WKN' , name : 'West Kensington', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'WMS' , name : 'Westminster', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'WCL' , name : 'Whitechapel', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'WDN' , name : 'Wimbledon', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}},
			{ code : 'WMP' , name : 'Wimbledon Park ', atLength : 0 ,position : { x : 0, y : 0, type: 'circle', text : '-'}}
		]
	} 
